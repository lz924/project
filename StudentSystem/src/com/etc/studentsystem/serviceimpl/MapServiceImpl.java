...
import com.etc.studentsystem.daoimpl.ListDaoImple;
import com.etc.studentsystem.daoimpl.MapDaoImpl;
import com.etc.studentsystem.entity.Student;
import com.etc.studentsystem.service.StudentService;

public class MapServiceImpl implements StudentService {
    StudentDao dao = new MapDaoImpl();
